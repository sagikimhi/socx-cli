...
from socx.core.metadata import __author__
from socx.core.metadata import __appname__
from socx.core.metadata import __directory__
...
def find_project_root(start_path: Path) -> Path:
    ...
    if has_local_config(start_path):
...
PROJECT_ROOT_DIR: Path = find_project_root(Path.cwd())
"""Path to project root directory if such exists, otherwise None."""

PROJECT_ROOT_CONFIG: Path = PROJECT_ROOT_DIR / LOCAL_CONFIG_FILENAME
